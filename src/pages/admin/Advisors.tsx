        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Monitore o desempenho e gerencie as comissões dos assessores
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <span className="text-2xl font-bold text-gray-900">
              {new Intl.NumberFormat('pt-BR', {
                ...
                advisors.reduce((acc, a) => acc + (a.totalCommission || 0), 0)
              )}
            </span>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <span className="text-2xl font-bold text-gray-900">
              {new Intl.NumberFormat('pt-BR', {
                ...
                advisors.length
                  ? advisors.reduce((acc, a) => acc + (a.totalRaised || 0), 0) / advisors.length
                  : 0
              )}
            </span>
          </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredAdvisors.map((advisor) => (
                <tr key={advisor.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{advisor.activeInvestors}</td>
